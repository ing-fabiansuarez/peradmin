...
<?= $this->section('active-cotizador-normal') ?>active<?= $this->endSection() ?>
...
<div class="container-fluid">
    ...
    if (isset($_POST['crud'])) {
        if ($_POST['crud'] == 'set') {
            ...
            $ropa = $sisa + $larga + $cuellotortuga + $pantalonetas + $buso  + $camisetas + $leggingscuerina + $bicicleterocuerina + $faldacuerina + $leggings + $leggingsninho + $jeans + $bikini + $pijamas;
            if ($_POST['mediasm'] == '') {
                $mediasm = 0;
                $valormediasm = 0;
            } else {
            ...
            } elseif ($alpargatas >= 12 and $alpargatas < 100) {
                if ($_POST['clasicas'] == '' or $_POST['clasicas'] == 0) {
                    $clasicas = 0;
                    $valorclasicas = 0;
                } else {
            ...
            ///////ROPA////////
            ///////////////////
            if ($ropa >= 100) { //para mayores de 100
                //PIJAMA
            ...
            } elseif ($ropa >= 8 and $ropa < 100) { //Para mayores de 8 y menores a 100
                //PIJAMA
                if ($_POST['pijamas'] == '' or $_POST['pijamas'] == 0) {
                    $pijamas = 0;
                    $valorpijamas = 0;
                ...
                $totalbikini = $bikini * $valorbikini;
            } elseif ($ropa < 8) { //para ventas de ropa al detal
                //PIJAMA
                if ($_POST['pijamas'] == '' or $_POST['pijamas'] == 0) {
                    $pijamas = 0;
                    $valorpijamas = 0;
        ...
        $totalropa = $totalsisa + $totallarga + $totalcuellotortuga + $totalpantalonetas + $totalbuso + $totalcamisetas +
            $totalleggings + $totalleggingsninho + $totalleggingscuerina + $totalbicicleterocuerina + $totalfaldacuerina + $totaljeans + $totalbikini + $totaltapabocas + $totalpijamas;
        ...
        $templateproductos = ('
                        <form action="' . base_url() . route_to('quoter_normal') . '" method="POST">
                        <table class="">
                            <thead>
                                <tr>
                            ...
                            <tr>
                                ...
                                <td scope="col"><input name="clasicas" class="caja-texto" type="number" value="' . $clasicas . '"></td>
                                <td scope="col"><input name="valorclasicas" class="caja-texto" type="number" value="' . $valorclasicas . '"></td>
                                <td scope="col"><input name="radioclasicas" class="caja-texto" type="checkbox"></td>
                                <td scope="col">' . $totalclasicas . '</td>
                            </tr>
                            <tr>
                                <td scope="col">Plataformas</td>
                                <td scope="col"><input name="plataformas" class="caja-texto" type="number" value="' . $plataformas . '"></td>
                                <td scope="col"><input name="valorplataformas" class="caja-texto" type="number" value="' . $valorplataformas . '"></td>
                                <td scope="col"><input name="radioplataformas" class="caja-texto" type="checkbox"></td>
                                <td scope="col">' . $totalplataformas . '</td>
                            </tr>
                            <tr>
                        ...
                        <input class="agregar-producto" type="submit" value="COTIZAR">
                        <input type="hidden" name="r" value="cotizador">
    ...
    if (!empty($alpargatas)) {
        $resumentotalalpargatas = ('
                <tr class="resumencotizador">
                    <td scope="col"></td>
                    <td scope="col"><b>TOTAL ALPARGATAS</b></td>
                    <td scope="col"></td>
                    <td scope="col"><b>' . number_format($totalalpargatas) . '</b></td>
                </tr>
                ');
    } else {
        $resumentotalalpargatas = ('');
    ...
    if (!empty($ropa)) {
        $resumentotalropa = ('
                <tr class="resumencotizador">
                    ...
                    <td scope="col"></td>
                    <td scope="col"><b>' . number_format($totalropa) . '</b></td>
                </tr>
            ');
    } else {
        $resumentotalropa = ('');
    ...
    if (!empty($medias)) {
        $resumentotalmedias = ('
                <tr class="resumencotizador">
                    ...
                    <td scope="col"></td>
                    <td scope="col"><b>' . number_format($totalmedias) . '</b></td>
                </tr>
            ');
    } else {
        $resumentotalmedias = ('');
    ...
    if (!empty($rizos)) {
        $resumentotalrizos = ('
                <tr class="resumencotizador">
                    ...
                    <td scope="col"></td>
                    <td scope="col"><b>' . number_format($totalrizos) . '</b></td>
                </tr>
            ');
    } else {
        $resumentotalrizos = ('');
    ...
    if (!empty($plantillas)) {
        $resumentotalplantillas = ('
                <tr class="resumencotizador">
                    ...
                    <td scope="col"></td>
                    <td scope="col"><b>' . number_format($totalplantillas) . '</b></td>
                </tr>
            ');
    } else {
        $resumentotalplantillas = ('');
    ...
    if (!empty($totalproductos)) {
        $resumentotal = ('
                <tr>
                    ...
                    <td scope="col"></td>
                    <td scope="col"><b>' . number_format($totalproductos) . '</b></td>
                </tr>
            ');
    } else {
        $resumentotal = ('');
    ...
    if (!empty($flete)) {
        $resumenflete = ('
            <tr>
                ...
                <td scope="col"></td>
                <td scope="col">' . number_format($flete) . '</td>
            </tr>
        ');
    } else {
        $resumenflete = ('');
    ...
    if (!empty($clasicas)) {
        if ($clasicas > 0) {
            $resumenclasicas = ('
                <tr>
                <td scope="col">' . $clasicas . ' </td>
                <td scope="col"><img class="peraimg2" width="60px" src="./public/img/corporativas/peraimg.png" alt=""> Cl&aacute;sicas</td>
                <td scope="col">(C/U a ' . number_format($valorclasicas) . ')</td>
                <td scope="col">' . number_format($totalclasicas) . '</td>
                </tr>
                ');
        } else {
            $resumenclasicas = '';
    ...
    if (!empty($cantidadtapabocas)) {
        if ($cantidadtapabocas > 0) {
            $resumentapabocas = ('
            <tr>
            <td scope="col">' . $cantidadtapabocas . ' </td>
            <td scope="col"><img class="peraimg2" width="60px" src="./public/img/corporativas/peraimg.png" alt=""> Tapabocas</td>
            <td scope="col">-</td>
            <td scope="col">' . number_format($totaltapabocas) . '</td>
            </tr>
            ');
        } else {
            $resumentapabocas = '';
    ...
    if (!empty($rizos)) {
        if ($rizos > 0) {
            $resumenrizos = ('
                <tr>
                <td scope="col">' . $rizos . ' </td>
                <td scope="col"><img class="peraimg2" width="60px" src="./public/img/corporativas/peraimg.png" alt=""> PeRa Rizos</td>
                <td scope="col">(C/U a ' . number_format($valorrizos) . ')</td>
                <td scope="col">' . number_format($totalrizos) . '</td>
                </tr>
                ');
        } else {
            $resumenrizos = '';
    ...
    if (!empty($plataformas)) {
        if ($plataformas > 0) {
            $resumenplataformas = ('
                <tr>
                <td scope="col">' . $plataformas . ' </td>
                <td scope="col"><img class="peraimg2" width="60px" src="./public/img/corporativas/peraimg.png" alt=""> Plataformas</td>
                <td scope="col">(C/U a ' . number_format($valorplataformas) . ')</td>
                <td scope="col">' . number_format($totalplataformas) . '</td>
                </tr>
                ');
        } else {
            $resumenplataformas = '';
    ...
    if (!empty($perablack)) {
        if ($perablack > 0) {
            $resumenperablack = ('
                <tr>
                <td scope="col">' . $perablack . ' </td>
                <td scope="col"><img class="peraimg2" width="60px" src="./public/img/corporativas/peraimg.png" alt=""> PeRa Black</td>
                <td scope="col">(C/U a ' . number_format($valorperablack) . ')</td>
                <td scope="col">' . number_format($totalperablack) . '</td>
                </tr>
                ');
        } else {
            $resumenperablack = '';
    ...
    if (!empty($clasicaspiedrita)) {
        if ($clasicaspiedrita > 0) {
            $resumenclasicaspiedrita = ('
                <tr>
                <td scope="col">' . $clasicaspiedrita . ' </td>
                <td scope="col"><img class="peraimg2" width="60px" src="./public/img/corporativas/peraimg.png" alt=""> Cl&aacute;sicas Piedritas</td>
                <td scope="col">(C/U a ' . number_format($valorclasicaspiedrita) . ')</td>
                <td scope="col">' . number_format($totalclasicaspiedrita) . '</td>
                </tr>
                ');
        } else {
            $resumenclasicaspiedrita = '';
    ...
    if (!empty($plataformaspiedrita)) {
        if ($plataformaspiedrita > 0) {
            $resumenplataformaspiedrita = ('
                <tr>
                <td scope="col">' . $plataformaspiedrita . ' </td>
                <td scope="col"><img class="peraimg2" width="60px" src="./public/img/corporativas/peraimg.png" alt=""> Plataformas Piedritas</td>
                <td scope="col">(C/U a ' . number_format($valorplataformaspiedrita) . ')</td>
                <td scope="col">' . number_format($totalplataformaspiedrita) . '</td>
                </tr>
                ');
        } else {
            $resumenplataformaspiedrita = '';
    ...
    if (!empty($clasicasestrellita)) {
        if ($clasicasestrellita > 0) {
            $resumenclasicasestrellita = ('
                <tr>
                <td scope="col">' . $clasicasestrellita . ' </td>
                <td scope="col"><img class="peraimg2" width="60px" src="./public/img/corporativas/peraimg.png" alt=""> Cl&aacute;sicas estrellitas</td>
                <td scope="col">(C/U a ' . number_format($valorclasicasestrellita) . ')</td>
                <td scope="col">' . number_format($totalclasicasestrellita) . '</td>
                </tr>
                ');
        } else {
            $resumenclasicasestrellita = '';
    ...
    if (!empty($plataformasestrellita)) {
        if ($plataformasestrellita > 0) {
            $resumenplataformasestrellita = ('
                <tr>
                <td scope="col">' . $plataformasestrellita . ' </td>
                <td scope="col"><img class="peraimg2" width="60px" src="./public/img/corporativas/peraimg.png" alt=""> Plataformas estrellitas</td>
                <td scope="col">(C/U a ' . number_format($valorplataformasestrellita) . ')</td>
                <td scope="col">' . number_format($totalplataformasestrellita) . '</td>
                </tr>
                ');
        } else {
            $resumenplataformasestrellita = '';
    ...
    if (!empty($totalropa)) {
        if ($totalropa > 0) {
            $tercerosropa = ('
                <tr>
                <td scope="col"></td>
                <td scope="col"><b>Dinero de Terceros ROPA</b></td>
                </tr>
                ');
        }
    } else {
    ...
    if (!empty($totalrizos)) {
        if ($totalrizos > 0) {
            $tercerosrizos = ('
                <tr>
                <td scope="col"></td>
                <td scope="col"><b>Dinero de Terceros COSM&Eacute;TICOS</b></td>
                </tr>
                ');
        }
    } else {
    ...
    if (!empty($sisa)) {
        if ($sisa > 0) {
            $resumensisa = ('
                <tr>
                <td scope="col">' . $sisa . ' </td>
                <td scope="col"><img class="peraimg2" width="60px" src="./public/img/corporativas/peraimg.png" alt=""> Body Manga Sisa</td>
                <td scope="col">(C/U a ' . number_format($valorsisa) . ')</td>
                <td scope="col">' . number_format($totalsisa) . '</td>
                </tr>
                ');
        } else {
            $resumensisa = '';
    ...
    if (!empty($larga)) {
        if ($larga > 0) {
            $resumenlarga = ('
                <tr>
                <td scope="col">' . $larga . ' </td>
                <td scope="col"><img class="peraimg2" width="60px" src="./public/img/corporativas/peraimg.png" alt=""> Body Manga Larga</td>
                <td scope="col">(C/U a ' . number_format($valorlarga) . ')</td>
                <td scope="col">' . number_format($totallarga) . '</td>
                </tr>
                ');
        } else {
            $resumenlarga = '';
    ...
    if (!empty($cuellotortuga)) {
        if ($cuellotortuga > 0) {
            $resumencuellotortuga = ('
                <tr>
                <td scope="col">' . $cuellotortuga . ' </td>
                <td scope="col"><img class="peraimg2" width="60px" src="./public/img/corporativas/peraimg.png" alt=""> Body Cuello Tortuga</td>
                <td scope="col">(C/U a ' . number_format($valorcuellotortuga) . ')</td>
                <td scope="col">' . number_format($totalcuellotortuga) . '</td>
                </tr>
                ');
        } else {
            $resumencuellotortuga = '';
    ...
    if (!empty($pantalonetas)) {
        if ($pantalonetas > 0) {
            $resumenpantalonetas = ('
                <tr>
                <td scope="col">' . $pantalonetas . ' </td>
                <td scope="col"><img class="peraimg2" width="60px" src="./public/img/corporativas/peraimg.png" alt=""> Pantalonetas</td>
                <td scope="col">(C/U a ' . number_format($valorpantalonetas) . ')</td>
                <td scope="col">' . number_format($totalpantalonetas) . '</td>
                </tr>
                ');
        } else {
            $resumenpantalonetas = '';
    ...
    if (!empty($buso)) {
        if ($buso > 0) {
            $resumenbuso = ('
                <tr>
                <td scope="col">' . $buso . ' </td>
                <td scope="col"><img class="peraimg2" width="60px" src="./public/img/corporativas/peraimg.png" alt=""> Busos Caballero</td>
                <td scope="col">(C/U a ' . number_format($valorbuso) . ')</td>
                <td scope="col">' . number_format($totalbuso) . '</td>
                </tr>
                ');
        } else {
            $resumenbuso = '';
    ...
    if (!empty($enterizos)) {
        if ($enterizos > 0) {
            $resumenenterizos = ('
                <tr>
                <td scope="col">' . $enterizos . ' </td>
                <td scope="col"><img class="peraimg2" width="60px" src="./public/img/corporativas/peraimg.png" alt=""> Enterizos</td>
                <td scope="col">(C/U a ' . number_format($valorenterizos) . ')</td>
                <td scope="col">' . number_format($totalenterizos) . '</td>
                </tr>
                ');
        } else {
            $resumenenterizos = '';
    ...
    if (!empty($camisetas)) {
        if ($camisetas > 0) {
            $resumencamisetas = ('
                <tr>
                <td scope="col">' . $camisetas . ' </td>
                <td scope="col"><img class="peraimg2" width="60px" src="./public/img/corporativas/peraimg.png" alt=""> Camisetas</td>
                <td scope="col">(C/U a ' . number_format($valorcamisetas) . ')</td>
                <td scope="col">' . number_format($totalcamisetas) . '</td>
                </tr>
                ');
        } else {
            $resumencamisetas = '';
    ...
    if (!empty($leggings)) {
        if ($leggings > 0) {
            $resumenleggings = ('
                <tr>
                <td scope="col">' . $leggings . ' </td>
                <td scope="col"><img class="peraimg2" width="60px" src="./public/img/corporativas/peraimg.png" alt=""> Leggings Adulto</td>
                <td scope="col">(C/U a ' . number_format($valorleggings) . ')</td>
                <td scope="col">' . number_format($totalleggings) . '</td>
                </tr>
                ');
        } else {
            $resumenleggings = '';
    ...
    if (!empty($leggingscuerina)) {
        if ($leggingscuerina > 0) {
            $resumenleggingscuerina = ('
                <tr>
                <td scope="col">' . $leggingscuerina . ' </td>
                <td scope="col"><img class="peraimg2" width="60px" src="./public/img/corporativas/peraimg.png" alt=""> Leggings Cuerina</td>
                <td scope="col">(C/U a ' . number_format($valorleggingscuerina) . ')</td>
                <td scope="col">' . number_format($totalleggingscuerina) . '</td>
                </tr>
                ');
        } else {
            $resumenleggingscuerina = '';
    ...
    if (!empty($bicicleterocuerina)) {
        if ($bicicleterocuerina > 0) {
            $resumenbicicleterocuerina = ('
                <tr>
                <td scope="col">' . $bicicleterocuerina . ' </td>
                <td scope="col"><img class="peraimg2" width="60px" src="./public/img/corporativas/peraimg.png" alt=""> Bicicletero Cuerina</td>
                <td scope="col">(C/U a ' . number_format($valorbicicleterocuerina) . ')</td>
                <td scope="col">' . number_format($totalbicicleterocuerina) . '</td>
                </tr>
                ');
        } else {
            $resumenbicicleterocuerina = '';
    ...
    if (!empty($faldacuerina)) {
        if ($faldacuerina > 0) {
            $resumenfaldacuerina = ('
                <tr>
                <td scope="col">' . $faldacuerina . ' </td>
                <td scope="col"><img class="peraimg2" width="60px" src="./public/img/corporativas/peraimg.png" alt=""> Falda Cuerina</td>
                <td scope="col">(C/U a ' . number_format($valorfaldacuerina) . ')</td>
                <td scope="col">' . number_format($totalfaldacuerina) . '</td>
                </tr>
                ');
        } else {
            $resumenfaldacuerina = '';
    ...
    if (!empty($leggingsninho)) {
        if ($leggingsninho > 0) {
            $resumenleggingsninho = ('
                <tr>
                <td scope="col">' . $leggingsninho . ' </td>
                <td scope="col"><img class="peraimg2" width="60px" src="./public/img/corporativas/peraimg.png" alt=""> Leggings Niña</td>
                <td scope="col">(C/U a ' . number_format($valorleggingsninho) . ')</td>
                <td scope="col">' . number_format($totalleggingsninho) . '</td>
                </tr>
                ');
        } else {
            $resumenleggingsninho = '';
    ...
    if (!empty($jeans)) {
        if ($jeans > 0) {
            $resumenjeans = ('
                <tr>
                <td scope="col">' . $jeans . ' </td>
                <td scope="col"><img class="peraimg2" width="60px" src="./public/img/corporativas/peraimg.png" alt=""> Jeans</td>
                <td scope="col">(C/U a ' . number_format($valorjeans) . ')</td>
                <td scope="col">' . number_format($totaljeans) . '</td>
                </tr>
                ');
        } else {
            $resumenjeans = '';
    ...
    if (!empty($bikini)) {
        if ($bikini > 0) {
            $resumenbikini = ('
                <tr>
                <td scope="col">' . $bikini . ' </td>
                <td scope="col"><img class="peraimg2" width="60px" src="./public/img/corporativas/peraimg.png" alt=""> Bikini</td>
                <td scope="col">(C/U a ' . number_format($valorbikini) . ')</td>
                <td scope="col">' . number_format($totalbikini) . '</td>
                </tr>
                ');
        } else {
            $resumenbikini = '';
    ...
    if (!empty($mediasm)) {
        if ($mediasm > 0) {
            $resumenmediasm = ('
                <tr>
                <td scope="col">' . $mediasm . ' </td>
                <td scope="col"><img class="peraimg2" width="60px" src="./public/img/corporativas/peraimg.png" alt=""> Medias Dama</td>
                <td scope="col">(C/U a ' . number_format($valormediasm) . ')</td>
                <td scope="col">' . number_format($totalmediasm) . '</td>
                </tr>
                ');
        } else {
            $resumenmediasm = '';
    ...
    if (!empty($mediash)) {
        if ($mediash > 0) {
            $resumenmediash = ('
                <tr>
                <td scope="col">' . $mediash . ' </td>
                <td scope="col"><img class="peraimg2" width="60px" src="./public/img/corporativas/peraimg.png" alt=""> Medias Caballero</td>
                <td scope="col">(C/U a ' . number_format($valormediash) . ')</td>
                <td scope="col">' . number_format($totalmediash) . '</td>
                </tr>
                ');
        } else {
            $resumenmediash = '';
    ...
    if (!empty($plantillas)) {
        if ($plantillas > 0) {
            $resumenplantillas = ('
                <tr>
                <td scope="col">' . $plantillas . ' </td>
                <td scope="col"><img class="peraimg2" width="60px" src="./public/img/corporativas/peraimg.png" alt=""> Plantillas</td>
                <td scope="col">(C/U a ' . number_format($valorplantillas) . ')</td>
                <td scope="col">' . number_format($totalplantillas) . '</td>
                </tr>
                ');
        } else {
            $resumenplantillas = '';
    ...
    if (!empty($pijamas)) {
        if ($pijamas > 0) {
            $resumenpijamas = ('
                    <tr>
                    <td scope="col">' . $pijamas . ' </td>
                    <td scope="col"><img class="peraimg2" width="60px" src="./public/img/corporativas/peraimg.png" alt=""> Pijamas</td>
                    <td scope="col">(C/U a ' . number_format($valorpijamas) . ')</td>
                    <td scope="col">' . number_format($totalpijamas) . '</td>
                    </tr>
                    ');
        } else {
            $resumenpijamas = '';
    ...
    $all = ('
            <div class="row">
            <div class="col-sm-12 col-xs-12 col-md-6 col-lg-6 cotizador">
            ' . $templateproductos . '
            </div>
